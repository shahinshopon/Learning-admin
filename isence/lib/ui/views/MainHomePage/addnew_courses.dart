...
//Course Content
          ...
          //                       color: Color(0xff17242E).withOpacity(0.45),
          //                     ),
          //                   ),
          //                 ),
          //                 iconSize: 20.w,
          ...
          //                     child: Padding(
          //                       padding:
          //                           EdgeInsets.only(left: 9.w, right: 20.w),
          //                       child: Text(
          //                         value,
          //                         style: TextStyle(
          //                             fontFamily: 'SF Pro',
          ...
          //             CourseTextfield(context, "Vimeo or YouTube Video Link"),
          ...
          //                                             textAlign: TextAlign.left,
          //                                           ),
          //                                           Image.asset('close.png',
          //                                               height: 22,
          //                                               width: 22,
          //                                               fit: BoxFit.cover),
          //                                         ],
          //                                       ),
          //                                       Divider(color: AppColors.insane_primary.withOpacity(0.06),),
          //                                       RegularText('Chapter Title'),
          //                                       SizedBox(height: 5.h,),
          //                                       Container(
          //                                         height: 45.h,
          //                                         child: TextField(
          ...
          //                                                   .spaceBetween,
          //                                           children: [
          //                                             RegularText('Video URL'),
          //                                             RegularText('Video Title'),
          //                                             RegularText(''),
          //                                           ],
          //                                         ),
          //                                       ]),
          ...
          //                   InstructorButton(
          //                     'Back',
          //                     AppColors.insane_primary.withOpacity(0.08),
          //                   ),
          //                   SizedBox(
          //                     width: 230.w,
          //                   ),
          ...
          //                 children: [
          //                   CreatePostIdentity(
          //                       FontAwesomeIcons.user, 'Created by: Suhail'),
          //                   CreatePostIdentity(
          //                       FontAwesomeIcons.globe, 'ENGLSIH'),
          //                   CreatePostIdentity(
          //                       FontAwesomeIcons.calendar, 'March 2021'),
          //                 ],
          //               ),
          //               SizedBox(
          //                 height: 40.h,
          ...
          //                   CourseIncludes(
          //                       FontAwesomeIcons.phone, 'Full lifetime access'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextfieldHeader('Certificate Available for this course'),
                      Container(
                        height: 45.h,
                        width: MediaQuery.of(context).size.width / 2,
                        decoration: BoxDecoration(
          ...
          //                     fontSize: 15.sp,
          //                     fontWeight: FontWeight.w400,
          //                     color: AppColors.insane_primary.withOpacity(0.7),
          //                   )),
          //             ),
          //           ),
          //           TextfieldHeader(
          ...
          //               color: Color(0xffffffff),
          //               border:
          //                   Border.all(width: 1.0, color: Color(0xffCED3D6)),
          //             ),
          //             child: Padding(
          ...
          //                     },
          //                   ),
          //                   TextfieldHeader('Save Instructor For Future Use')
          //                 ],
          //               ),
          //               SizedBox(
          //                 width: 40.w,
